                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            ...
                            <h3 class="product-price text-danger fw-bold">Rp {{ number_format($product->price, 0, ',', '.') }}</h3>
                            
                            <form action="{{ route('cart.add', $product->id) }}" method="POST">
                                @csrf
                                <button type="submit" class="btn btn-gradient w-100 mt-3">🛒 Tambah ke Keranjang</button>
                            </form>
                        </div>
                    </div>
                </div>
